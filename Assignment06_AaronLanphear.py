...
# ALanphear,2.19.2021,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class IO:
    ...
    def input_new_task_and_priority():
        ...
        priority = input("What priority would you like to assign to it? - ")
...
while True:
    ...
    if strChoice.strip() == "1":  # Add a new Task
        ...
        strStatus = Processor.add_data_to_list(strTask, strPriority, lstTable)[1]
        IO.input_press_to_continue(strStatus)
        continue  # to show the menu

    elif strChoice == "2":  # Remove an existing Task
        strTask = IO.input_task_to_remove()
        strStatus = Processor.remove_data_from_list(strTask, lstTable)[1]
        IO.input_press_to_continue(strStatus)
        continue  # to show the menu
        ...
        if strChoice.lower() == "y":
            strStatus = Processor.write_data_to_file(strFileName, lstTable)[1]
            IO.input_press_to_continue(strStatus)
        else:
        ...
        IO.input_press_to_continue("'" + strChoice + "'" + " is not an available option. Please try again.")
